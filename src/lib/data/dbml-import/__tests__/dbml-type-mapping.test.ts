...
describe('DBML Type Mapping', () => {
  ...
  description text
        ...
        const idField = fields.find((f: DBField) => f.name === 'id');
        const nameField = fields.find((f: DBField) => f.name === 'name');
        const activeField = fields.find((f: DBField) => f.name === 'active');
        const createdAtField = fields.find(
            (f: DBField) => f.name === 'created_at'
        );
        const scoreField = fields.find((f: DBField) => f.name === 'score');
  ...
  data jsonb
        ...
        const idField = fields.find((f: DBField) => f.name === 'id');
        const dataField = fields.find((f: DBField) => f.name === 'data');
